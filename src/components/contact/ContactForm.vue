...
<template>
	<div class="w-full md:w-1/2">
		...
		>
			<p
				class="font-general-medium text-primary-dark dark:text-white text-2xl mb-8"
			>
				Contact Form
			</p>
			<form action="#" class="font-general-regular space-y-7 ">
				...
				<div>
					<Button
						title="Send Message"
						class="px-4 py-2.5 text-white tracking-wider bg-emerald-900 hover:bg-emerald-700 focus:ring-1 focus:ring-emerald-900 rounded-lg duration-500"
						type="submit"
